...
function usage() 
{
    ...
    echo "\tnav24\tDAS: C-Nav3050 Globally Corrected Global Positioning System (GcGPS)\n";
    echo "\tnav25\tDAS: \n";
    echo "\tnav26\tDAS: \n";
    echo "\tnav27\tDAS: \n";
    echo "\tnav29\tDAS: GGA, VTG, and ZDA strings, alternating line-by-line\n";
    echo "\tnav30\tDAS: \n";
    echo "\tnav31\tDAS: \n";
    echo "\tnav32\tDAS: \n";
    echo "\tnav33\tDAS: FKt nav ISO data followed by GGA\n";
    echo "\n";
    echo "\tsiomet\t\tDAS: Scripps Met System\n";
    echo "\tuhdas\t\tDAS: University of Hawaii Data Acquisition System (for ADCP)\n";
    echo "\tmetoc_nav\t\tDAS: USAP Navigation (OpenRVDAS)\n";
